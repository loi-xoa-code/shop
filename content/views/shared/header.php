...
<head>
	<base href="<?= PATH_URL; ?>" />
	<meta charset="utf-8">
	<title><?= isset($title) ? $title : 'Blue Electronics'; ?></title>
				...
				<div class="logo">
					<a href="home">
						<?php if (isset($linkLogo)) : ?>
							<img alt="Porto" width="157" height="54" data-sticky-width="116" data-sticky-height="40" src="public/img/<?= $linkLogo ?>"><?php endif; ?>
					</a>
				</div>
				<nav>
							...
							<li class="dropdown active">
								...
								<ul class="dropdown-menu">
									...
									<li class="dropdown-submenu">
										<a href="javascript:void(0);">Về Blue Electronics</a>
										<ul class="dropdown-menu">
