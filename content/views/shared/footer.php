<?php require_once('lib/users_online.php'); ?>
</div>
        ...
        <div class="row">
            ...
            <div class="col-md-3">
                ...
                <ul class="list icons list-unstyled push-top">
                    ...
                    <li><i class="fa fa-user"></i> <strong>Khách đang truy cập:</strong> <?= $users_online_total ?></li>
                </ul>
        ...
        <div class="container">
            <div class="row">
                <p>© Copyright <script>
                    ...
                    </script> - Phát triển bởi <span><a href="https://example.com">Nhóm Error</a></span>.</p>
            </div>
        </div>
    </div>
</footer>
