        ...
        <div class="row">
            <div class="col-lg-4 col-sm-12">
                <form class="card auth_form" method="POST" role="form" action="index.php?controller=forgot-password&amp;action=request">
                    <div class="header">
                        <img class="logo" src="/public/img/favicon-chikoiquan-tan-hong-it.png" alt="">
                        <h5>Quên mật khẩu ?</h5>
                ...
                <div class="copyright text-center">
                    ...
                    <span>Thiết kế: <a href="https://thememakker.com/" target="_blank">ThemeMakker</a></span><span> - Phát triển bởi <a href="https://example.com">Nhóm Error</a></span>
                </div>
            </div>
