...
if (!empty($_POST['email'])) {
    ...
    if (!preg_match("/([a-z0-9_]+|[a-z0-9_]+\.[a-z0-9_]+)@(([a-z0-9]|[a-z0-9]+\.[a-z0-9]+)+\.([a-z]{2,4}))/i", $email)) {
        ...
        try {
            $verificationLink = "https://blue-electronics.000.pe/index.php?controller=forgot-password&action=resultcode&code=" . $verificationCode;
            //content
            $htmlStr = "";
            $htmlStr .= "Xin chào " . $username . ' (' . $email . "),<br /><br />";
            $htmlStr .= "Chào mừng bạn đến với Blue Electronics.<br /><br /><br />";
            ...
            $htmlStr .= "Cảm ơn bạn đã tham gia và đồng hành cùng Blue Electronics.<br><br>";
            ...
            $mail->Subject = 'Forgot Password | Blue Electronics | Reset your Password | By Tân Hồng IT';
            $mail->Body = $htmlStr;
